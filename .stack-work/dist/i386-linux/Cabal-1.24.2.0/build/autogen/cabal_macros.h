...
/* package construct-yourself-0.1.0.0 */
#define VERSION_construct_yourself "0.1.0.0"
#define MIN_VERSION_construct_yourself(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "construct-yourself-0.1.0.0-JABwtlicEIdJDIZVdPab5M"

#define CURRENT_PACKAGE_KEY "construct-yourself-0.1.0.0-JABwtlicEIdJDIZVdPab5M"
